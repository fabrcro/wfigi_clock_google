...
float temp_offset = 0; // temperature offset
float rh_offset = 0; // hygrometer offset

char TempLabel[] = "    Temperature:  "; // Fixxed text
char UmiLabel[] = "    Humidity':  "; // Fixxed text

//WiFi parameters

const char ssid[] = "XXXXXX";  //  your network SSID (name)
const char password[] = "XXXXXXX4";       // your network password

// Localized Months and DoWeek - put yours....
...
//print data
  ...
  if(millis()-clkTime > 30000 && !del && dots) { // clock for 30s, then scrolls for about 30s
   ...
   printStringWithShift(date.c_str(),30);         //data1
